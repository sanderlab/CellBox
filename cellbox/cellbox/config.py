...
class Config(object):
    ...
    corruption_level (float): the sigma of Gaussian noise added onto expr data file during training, default: 0.
    ...
    def __init__(self, config_file):
        ...
        self.corruption_type = config_dict["corruption_type"] if "corruption_type" in config_dict else "none"
        self.corruption_level = config_dict["corruption_level"] if "corruption_level" in config_dict else 0
